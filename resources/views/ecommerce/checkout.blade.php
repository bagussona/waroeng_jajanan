                    ...
                    <div class="col-lg-8">
                        ...
                        <form class="row contact_form" action="{{ route('front.store_checkout') }}" method="post"
                            ...
                            <div class="col-md-12 form-group p_star">
                                ...
                                <input style="background-color: #ffffff;" type="text" class="form-control" id="first"
                                    name="name" value="{{ $user->name }}" required>
                                <p class="text-danger">{{ $errors->first('name') }}</p>
                            </div>
                            <div class="col-md-6 form-group p_star">
                                <label for="nohape">No Telp</label>
                                <input style="background-color: #ffffff; border: 0;" type="text" class="form-control"
                                    id="number" name="nohape" value="{{ $user->nohape }}" required readonly>
                                <p class="text-danger">{{ $errors->first('nohape') }}</p>
                            </div>
                            <div class="col-md-6 form-group p_star">
                                <label for="email">Email</label>
                                <input style="background-color: #ffffff; border: 0;" type="email" class="form-control"
                        ...
                        <div class="order_box">
                            ...
                            <ul class="list px-1 py-3">
                                <li class="list-inline-item px-5">
                                    <button type="submit" id="handle_multiple_click" class="main_btn">Konfirmasi
                                        Pesanan</button>
                                </li>
                            </ul>
                            </form>
