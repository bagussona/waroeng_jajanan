...
<body onload="realtimeClock(); activeButton()">
    <!--================Header Menu Area =================-->
                        ...
                        @guest
                            ...
                            <li class="nav-item submenu dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button"
                                    aria-haspopup="true" aria-expanded="false"><i class="fa fa-sign-in"></i> Sign In</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-link">
                                        <i class="fa fa-sign-in"></i><a href="{{ route('login') }}"
                                            class="nav-link">Sign In</a>
                                    </li>
                                    <li class="nav-link">
                                        <i class="fa fa-user-plus"></i><a href="{{ route('register') }}"
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                                    ...
                                    <img class="rounded-circle" style="width: 25px; height: 25px;"
                                        src="{{ Auth::user()->avatar }}" alt="admin@waroengjajanan.com">
                                </a>
                                ...
                                <ul class="nav navbar-nav navbar-right right_nav pull-right">
                                    ...
                                    @auth
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('front.notfound') }}" class="icons">
                                                <i class="fa fa-heart-o" aria-hidden="true"><span
                                                        class="badge bg-warning">0</span></i>
                                            </a>
                                        </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('front.list_cart') }}" class="icons">
                                            <i class="lnr lnr lnr-cart cart-icon"><span class="badge bg-warning">
                                                    {{ $licart }}</span></i>
                                        </a>
                                    </li>
                                    <hr>
            ...
            <div class="row">
                <div class="col-lg-3  col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <p>{{ env('APP_NAME') }} adalah umkm yang sedang berkembang, {{ env('APP_NAME') }} ini
                            berbasis online, untuk membeli jajanan cukup pesan lewat webapp.</p>
                    </div>
                </div>
                            ...
                            <form target="_blank" action="" method="get" class="subscribe_form relative">
                                <div class="input-group d-flex flex-row">
                                    <input name="email" placeholder="email address.." onfocus="this.placeholder = ''"
                                        onblur="this.placeholder = 'Input yur email.. '" required="" type="email">
            ...
            <div class="row footer-bottom d-flex justify-content-between align-items-center">
                <p class="col-lg-12 footer-text text-center">
                    ...
                    <i class="fa fa-heart-o" aria-hidden="true"></i> by <a
                        href="https://github.com/bagussona">Bagus</a>
                </p>
            </div>
        </div>
    </footer>
    ...
    <script>
        // MEMBUAT TAMPILAN JIKA TAB MENU DIPILIH MAKA KELAS ACTIVE AKAN DITAMBAHKAN
        let navigation = document.querySelectorAll('.navigation, .cart-icon, .user-icon');

        let currentUrl = window.location.href;
        let nowUrl = currentUrl.split('/');
        ...
        //console.log(navigation.firstElementChild.href);
        let buttonAdd = document.getElementById('handle_multiple_click');
        let buttonDelete = document.getElementsByClassName('btn_danger');
        document.body.onclick = function(e) {
            if (e.target == buttonDelete[0] || e.target == buttonAdd) {
