                        ...
                        <div class="body-main-content-middle-rightside" style="width: 95% height: 50px;">
                            <table id="table-pendapatan" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; font-family: 'Nunito Sans', sans-serif;">{{ $i++ }}</td>
                                    <td style="text-align: left; font-family: 'Nunito Sans', sans-serif;">{{ $val->status }}</td>
                                    <td style="text-align: center; font-family: 'Nunito Sans', sans-serif;">{{ $val->invoice }}</td>
                                    <td style="text-align: right; font-family: 'Nunito Sans', sans-serif;">{{ $val->customer_name }}</td>
